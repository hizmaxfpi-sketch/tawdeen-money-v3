...
export const BUSINESS_EXPENSE_CATEGORIES = ['expense', 'business_expense', 'asset_depreciation', 'salary', 'rent', 'utilities', 'marketing', 'supplies', 'transport', 'maintenance', 'other_expense', 'asset_improvement', 'production_expense', 'production_cogs'];
...
export const EXPENSE_CATEGORIES = [
  ...
  { value: 'production_cogs', label: 'تكلفة مواد مباعة' },
