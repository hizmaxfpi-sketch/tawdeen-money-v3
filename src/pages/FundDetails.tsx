...
export function FundDetails({ funds, transactions, currencies = [], onUpdateFund, onDeleteFund, onDeleteTransaction, onRefresh }: FundDetailsProps) {
  ...
  // ✅ نقرأ من الـ prop مباشرة — useTransactions يجلب كل العمليات أصلاً (PAGE_SIZE=1000 + كاش)
  // لا داعي لجلب مكرر يسبب وميض/تأخير عند فتح كل صندوق
